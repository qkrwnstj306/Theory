...
$$ X_{t-1} = \sqrt{\bar{\alpha}_t}X_0 + \sqrt{1-\bar{\alpha}_t} \epsilon_{t-1} $$

$$ X_{t-1} = \sqrt{\overline{\alpha}_{t-1}}X_0 + \sqrt{1-\overline{\alpha}_{t-1}} $$

$$ X_{t-1} = \sqrt{\overline{\alpha_{t-1}}}X_0 + \sqrt{1-\overline{\alpha_{t-1}}} $$
